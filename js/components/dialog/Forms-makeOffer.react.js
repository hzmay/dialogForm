...
// 报价信息
export default class FormsMakeOffer extends React.Component {
	_bind(...methods) {
	...
	render(){
		var userInfo = this.state.userInfo;
		return (
			<form id="MakeOffer-wp" className="fadeIn animated" onSubmit={this.handleSubmit}>
				<fieldset>
					<legend>报价信息</legend>
					...
					<label htmlFor="userPrice">
						<span className="wx-dollar"></span>
						<em></em>
						<div>
							<input ref="userPrice" id="userPrice" type="text" 
								placeholder="报价" 
